//===================================================================
// Modified from https://github.com/enthusiasticgeek/gstreamer-rtsp-ssl-example/blob/master/rtsp_server.c#L146
...
#define FILENAME "/home/guard/PioTGuard-Server-v1/config/rtsp_parameters.conf"
#define MAXBUF 2048
#define DELIM "="
